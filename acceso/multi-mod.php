...
$ssql=sprintf("SELECT titulo,contenido,dia,mes,ano,autor,id_multimedia FROM multimedia WHERE id_multimedia='".$_GET["num"]."'");
...
?>
  ...
  <div class="contenedor">
    <div class="cont-inf-mont">
      ...
      <form action="multi-modf.php" method="post" name="form1" id="form1" style="margin-left:0; width:900px;">
      <input type="hidden" name="id_multimedia" value="<?php echo $id_multimedia ?>" />
        <label> Titulo<br />
    ...
    <div class="mont-img">
      <form action="ins_img.php" method="post" enctype="multipart/form-data" name="form2" id="form2" style="margin-bottom:30px;">
        ...
        <input type="hidden" name="pagina" value="multi-mod.php?num=<?php $id_multimedia ?>" />
...
Foreach ($ficheros1 as $valor)
{
	if ($valor == '.' or $valor == '..'){
		...
		echo '<input type="hidden" name="pagina" value="multi-mod.php?num='.$id_multimedia.'" />';
