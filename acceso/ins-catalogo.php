...
"correcto"){
    echo '
<SCRIPT LANGUAGE="javascript">location.href = "http://www.google.co.ve/";</SCRIPT>
';
}
//nombre de la imagen a borrar
$borrar=$_POST["nomb_act"];
//nombre de la nueva imagen
$id_img=$_POST["nomb_sig"];
...
';*/
    ...
    if ($nombre_archivo){
        if (!((strpos($tipo_archivo, "gif") || strpos($tipo_archivo, "jpeg") || strpos($tipo_archivo, "png")) && ($tamano_archivo
< 10000000))) {
            $aviso ='the file type is not right.<br />
Remember, only use files .gif, .jpg o .png';
        }
        else{
...
/*echo '
<SCRIPT LANGUAGE="javascript">location.href = "javascript:window.history.go(-1)";</SCRIPT>
';*/
