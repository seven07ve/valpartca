...
?>
  ...
  <div class="contenedor">
    <div class="cont-inf-mont">
      <h2>Agregar Artículo Multimedia</h2>
      <form action="multi-insd.php" method="post" name="form1" id="form1" style="margin-left:0; width:900px;">
...
Foreach ($ficheros1 as $valor)
{
	if ($valor == '.' or $valor == '..'){
		...
		echo '<input type="hidden" name="pagina" value="multi-ins.php" />';
