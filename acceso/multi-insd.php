...
//insertar
$isql=("INSERT INTO multimedia (titulo,contenido,dia,mes,ano,autor) VALUES ('".addslashes($_POST['titulo'])."','".addslashes($_POST['elm1'])."','".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["autor"]."')");
//ejecuta la sentencia usql
$insertar = $mysqli->query($isql);
//guarda el numero de la ultima id creada por autoincremento
$id_multimedia = $mysqli->insert_id;
...
?>
  ...
  <div class="contenedor">
    <div style="float:left; width:900px; height:800px; margin:30px 3% 0; display:inline-block;">
      <h2> Artículo Multimedia Agregado</h2>
    ...
    <div class="mont-img">
      <form action="ins_img.php" method="post" enctype="multipart/form-data" name="form2" id="form2" style="margin-bottom:30px;">
        ...
        <input type="hidden" name="pagina" value="multi-ins.php" />
