...
<title>Unidades Vendidas por Vendedor y por Clasificación de la Familia</title>
...
<%
	...
	SQL = " SELECT B300121DEC "
	SQL = SQL & " FROM X300BF121 " 
	SQL = SQL & " WHERE "
	SQL = SQL & " B300121CCI = '" & Session("glCiaInternet") & "' AND " 
	SQL = SQL & " B300121NLP = '" & wNLP & "'" 
	Set rstQuery = Server.CreateObject("ADODB.Recordset")
    rstQuery.Open sql , strCnn
	IF NOT rstQuery.EOF THEN		
		wDEC = TRIM(rstQuery.Fields("B300121DEC"))
	END IF
	rstQuery.Close 
	set rstQuery = nothing
...
<!--
	...
	<tr>
		...
		<font size="2"><b>Clasificación</b></font><b><font face="Tahoma" size="2"></font></b></u></td>
	...
	<tr>
		...
		<font size="2"><b>Unidades Vendidas</b></font></td>
		
			</tr>
-->			

	<%			
		SQL = " SELECT B300201CLA, "
		...
		SQL = SQL & " AND B300201NLP = '" & wNLP & "' "
		SQL = SQL & " GROUP BY B300201CLA "
		...
		DO WHILE NOT rstQuery.EOF 
			...
			wCPR = TRIM(rstQuery.Fields("B300201CLA"))
...
<div id="chart_div3" style="width: 600px; height: 300px; text-align: center;" ></div>
...
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options3 = {
          title: 'Venta en Unidades',
          //isStacked: true,
          left: '0',
          width: '600',
          height: '300',
          trigger: 'selection',
          hAxis: {title: 'Clasificación', textStyle: {fontSize: '12'} , titleTextStyle: {color: 'Blue'}},
