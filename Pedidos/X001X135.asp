...
<%	ELSE %>
	<body topmargin="0" leftmargin="18" rightmargin="0" bottommargin="0" vlink="#0000FF" onload="window.status='<%=Request.ServerVariables("URL")%>'" style="text-align: center" scroll="YES" bgcolor="<%=Request.Cookies("CAR")("Color1")%>"  >
		<table border="0" height="100%" width="919" align="center" bgcolor="#ffffff" cellpadding="0" cellspacing="0"   ><tr><td valign="top"  >
		<table BORDER="0" WIDTH="919" bgcolor="#FFFFFF" align="center" cellpadding="6"  >
<%	END IF
	...
	SQL = "SELECT B300126NLP, B300126CPC " 
	SQL = SQL & " FROM X300BF126"
	SQL = SQL & " WHERE "
	...
	DO WHILE NOT rstQuery.EOF 'and wCuenta < wRegistros 
		...
		SQL = "SELECT A300035DPC FROM X300AF035 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " A300035CCI = '" & Session("glCiaInternet") & "' AND "
		SQL = SQL & " A300035CPC = '" & wC02 & "'  "		
		'Response.Write sql
