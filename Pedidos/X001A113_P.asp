...
<%
    ...
    <table align="center"  bordercolor="#ffffff" bgcolor="<%=Request.Cookies("CAR")("Color2")%>" BORDER="1" WIDTH="919" height="30" cellspacing="0" style="border-style: inset; border-width: 1px; padding-left: 2px; padding-right: 2px; padding-top: 1px; padding-bottom: 1px" WIDTH="760" >

    <TR>
		<td CLASS="TDP" width="42%" align="center"><A href="<%=wURLP %>" target="main1">Buscar</A></td>		  
		<td CLASS="TDP" width="42%" align="center"><A href="javascript:window.open('X001A005.asp','main');" target="_parent">Regresar</A></td>	
