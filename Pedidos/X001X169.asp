...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
	...
	wTIT = "Lineas Producto de Interes" 
	wCLA001 = trim(Request.QueryString("CLA001"))
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF707 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300707CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300707LIN ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("P300707DEC"))
			wPUS = trim(rstQuery.Fields("P300707PUS"))
			wFAC = trim(rstQuery.Fields("P300707FAC"))
