...
wURL  = "X001A101"   'Colocar nombre principal de pagina
...
<meta name="ProgId" content="FrontPage.Editor.Document">
  ...
  <% IF wURLD2 = "X001A101.asp" THEN %>
	 <frameset rows="55,*,155" framespacing="0" border="0" frameborder="0">
