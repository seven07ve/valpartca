...
<%
 ...
 'response.write wSPP 
 	...
 	wCLA008 = trim(Request.QueryString("CLA008"))
...
<% END IF %>
 ...
 <tr>
    <td width="919" align= "center" style="border-left:1px solid #0066CC; border-right:1px solid #0066CC; border-top:1px solid #0066CC; ">
...
<% IF wSPP = "0" THEN  %>  
	...
	<td width="4%" >
          ...
          <td width="4%"  height="30px">
            <p align="right"><span class="auto-style1">Presentación</span><font color="#000000" style="font-size: 8pt" >:</font></p>
          </td>
          <td align="right" >
          ...
          <tr>
          <td style="border-style: none; border-width: medium; width: 93%;" valign="middle" >
          <% IF wPARCON <> "1" THEN %>
            <p align="right">
...
<tr>
          <td style="border-style: none; border-width: medium; width: 336px;" >
            <p align="center">
