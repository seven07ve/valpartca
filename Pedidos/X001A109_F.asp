...
wURL  = "X001A109"   'Colocar nombre principal de pagina
...
<meta name="ProgId" content="FrontPage.Editor.Document">
  ...
  <% IF wURLD2 = "X001A109.asp" THEN %>
	 <frameset rows="40,*,80" framespacing="0" border="0" frameborder="0">
