...
<%
	...
	wURLB = "X001X130.ASP?URLTIT=" & wURLTIT
...
<FORM NAME="FrmBuscar" METHOD="post" ACTION="<%=wURLB%>" target="main1" onSubmit="javascript:return Validar()" >	 
	 <BODY bgcolor="<%=Request.Cookies("CAR")("Color1")%>"  align="center" style="text-align: center" topmargin="0" leftmargin="0" rightmargin="0"  >
  ...
  <tr>
	...
	<table align="center"  BORDER="1" WIDTH="100%">
        ...
        <font color="#000000" style="font-size: 8pt; font-weight:700">*Para 
			Visualizar las Facturas seleccione y presione el Botón &quot;Buscar&quot;</span>    
...
<tr>         
	...
	<td CLASS="TDP" width="10%" style="border-style: none; " >
            <p align="right"><span style="font-size: 8pt">Vendedor:</font></p>
          </td>
          <td CLASS="TDP"  align="right" style="border-style: none; "  >
			<SELECT class="con_estilos" name="VENDEDORES" type="select-one" SelectedIndex size="1" ondblclick="Javascript:enviar2();" onChange="Javascript:enviar2();"  > 
									<%
        ...
        <% End If %>
          ...
          <td  CLASS="TDP" align="right" style="border-style: none; " >
			<SELECT class="con_estilos" name="FAMILIA" type="select-one" SelectedIndex size="1" onchange="enviar();" ondblclick="enviar();" > 
									<%
        ...
        <p align="center"><font color="#FF0000"><span style="font-weight: 700; font-size: 9pt">SOLO SE 
		VISUALIZARAN FACTURAS EMITIDAS DEL MES ANTERIOR Y EL ACTUAL</span></font></td>
        <td CLASS="TDP" style="border-style: none; border-width: medium; " >&nbsp;
        </td>
        <td CLASS="TDP" style="border-style: none; border-width: medium; ">
...
function enviar2() {
	...
	var url = "X001X130_P.asp?URLACT=<%=wURLACT%>&URLIMP=<%=wURLIMP%>&URLPRI=<%=wURLPRI%>&URLTIT=<%=wURLTIT%>&CAMC01=<%=wCAMC01%>&CAMC02=<%=wCAMC02%>&PAR=<%=wPAR%>&CVE="+document.FrmBuscar.VENDEDORES.value
