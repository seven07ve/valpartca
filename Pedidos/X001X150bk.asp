...
<%
	...
	wTIT = "PQR'S  Registradas en la Web" 
...
<td bgcolor="#FFFFFF" align ="center" >
	 ...
	 <tr>
          ...
          <td class="TDD" width="73%" height="20" valign="middle" ><p CLASS="P1"><b>
                    ...
                    <SELECT name="MOTIVO" type="select-one" SelectedIndex style="font-family: Tahoma; font-size: 8pt" size="1" > 
									...
									SQL = " SELECT A300050STS, A300050DEL FROM X300AF050 " 	
									SQL = SQL & " WHERE "
									SQL = SQL & " A300050CCI = '" & wCCI & "' AND "
									SQL = SQL & " A300050CIA = '" & wCIA & "' "
									SQL = SQL & " ORDER BY  A300050DEL " 																		
									Set rstQuery = Server.CreateObject("ADODB.Recordset")
									rstQuery.Open sql , strCnn
									'Response.write "<OPTION value=000>TODOS</OPTION>" 										
                                    DO WHILE NOT rstQuery.EOF 
										wCOD = trim(rstQuery.Fields("A300050STS"))
 ...
 <tr>
		  <td class="TDS" width="24%" height="20" ><p CLASS="P1" align="left">
			Motivo</p> </td>
          <td class="TDD" width="73%" height="20" valign="middle" ><p CLASS="P1"><b>
               <SELECT name="TRE" type="select-one" SelectedIndex style="font-family: Tahoma; font-size: 8pt" size="1" > 
				<OPTION value=000>TODOS</OPTION>
				<OPTION value="Defecto de Parte">Defecto de Parte</OPTION>
				...
				<OPTION value="Error en Ventas">Error en Ventas</OPTION>				
				<OPTION value="Faltante">Faltante</OPTION>
				<OPTION value="Sobrante">Sobrante</OPTION>
				<OPTION value="Faltante y Sobrante">Faltante y Sobrante</OPTION>
				</SELECT>          
          </b></P></td>
         </tr>
