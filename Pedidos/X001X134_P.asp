...
<table WIDTH="919" bgcolor="#FFFFFF" align="center" height="100%"><tr><td valign="top" >
    ...
    <TR>
			...
			<td CLASS="TDP" width="50%" align="center" height="30"><A href="<%=wURLI %>" target="_blank">Imprimir</A></td>		  
			
				  
			<td CLASS="TDP" width="50%" align="center"><A href="X001X002.ASP" target="_parent">Volver</A></td>		  
