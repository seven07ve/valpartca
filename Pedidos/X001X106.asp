...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300AF034 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " A300034CCI = '" & wCCI & "' AND "
		SQL = SQL & " A300034CIA = '" & wCIA & "' AND "		
		SQL = SQL & " A300034CBN ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("A300034DEL"))
			wNCB = trim(rstQuery.Fields("A300034NCB"))
			wPUS = trim(rstQuery.Fields("A300034PUS"))
			wFAC = trim(rstQuery.Fields("A300034FAC"))
...
<br>
   <table align="center" BORDER="1" WIDTH="650" cellspacing="0" cellpadding="0"  bordercolor="#FFFF" bgcolor="<%=Request.Cookies("CAR")("Color2")%>" style="border-style: inset; border-width: 1px; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
	  ...
	  <table BORDER="0" WIDTH="100%" cellpadding="5" >
		 ...
		 <tr>
          <td class="TDS" width="20%" ><p CLASS="P1" align="left">Nro. de 
		  Cuenta:</p></td>
          <td class="TDD" width="80%" >
				<INPUT NAME="NCB" size=50 value="<%=wNCB%>" maxlength="30">
