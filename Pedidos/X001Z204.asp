...
<p align=center>&nbsp;
	...
	criterio para la búsqueda de Prospectos.</font></b></td></tr>
    </table> 
    </p>
    <p>
	...
	DO WHILE NOT rstQuery.EOF and len(trim(wCLA001)) > 0 
		...
		IF wCuenta = 0 Then
			...
			Response.Write "<table BORDER=""0"" WIDTH=""100%"" cellpadding=""6"">"
		 	...
		 	Response.Write "<tr><td class=""TDS"" width=""20%"" ><p CLASS=""P1"" align=""center"">Código</p></td>"
         	Response.Write "<td class=""TDS"" width=""60%""><p CLASS=""P1"" align=""left"">Descripción</p></td>"
