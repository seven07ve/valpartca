...
<title>Unidades Vendidas por Familia por Cliente y Por Producto</title>
...
<p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
	...
	<tr>
		<td colspan="3"  style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium; width:10%" align="CENTER">
	...
	<tr>
		...
		<font face="Tahoma" size="2"><b><% =wCCL & " - " & wRSO %></b> </font> 
		</td>
	</tr>
	<tr>
	...
	<%			
		...
		SQL = " SELECT isnull(SUM(B300200UPE),0) AS B300200UPE "
		SQL = SQL & "  FROM X300BF200 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " B300200FEC >= '" & wFED & "' AND "
		SQL = SQL & " B300200FEC <= '" & wFEH & "' AND "
		SQL = SQL & " B300200CVE = '" & wCVE & "' AND "
		SQL = SQL & " B300200CCL = '" & wCCL & "' "
		'RESPONSE.WRITE SQL 
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
    	rstQuery.Open sql , strCnn
		IF NOT rstQuery.EOF THEN
		
			wFLETE = cdbl(rstQuery.Fields("B300200UPE"))
		...
		SQL = " SELECT isnull(B300200PPR,0) as B300200PPR, B300201CPR, "
		SQL = SQL & " B300201DEC, B300201DEL, ISNULL(SUM(B300201UPE*B300201UNR), 0) AS UVE, "
		SQL = SQL & " ISNULL(SUM(B300201MNE), 0) AS MNE "
		SQL = SQL & " FROM X300BF201, X300BF200 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " B300200CCI = B300201CCI AND "
		...
		SQL = SQL & " AND B300200CCL = '" & wCCL & "' "
		SQL = SQL & " GROUP BY B300200PPR, B300201CPR, B300201DEC, B300201DEL "
		...
		DO WHILE NOT rstQuery.EOF 
			...
			wDEC = TRIM(rstQuery.Fields("B300201DEC"))
			wDEL = TRIM(rstQuery.Fields("B300201DEL"))
			wPPR = cdbl(rstQuery.Fields("B300200PPR"))
