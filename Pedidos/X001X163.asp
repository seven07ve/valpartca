...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF704 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300704CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300704CRE ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("P300704DES"))
			wPUS = trim(rstQuery.Fields("P300704PUS"))
			wFAC = trim(rstQuery.Fields("P300704FAC"))
