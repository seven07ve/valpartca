...
<%	END IF
	...
	DO WHILE NOT rstQuery.EOF 'and wCuenta < cint(Session("glRegistros"))
		...
		wC02 = left(trim(rstQuery.Fields("A300003DEL")),35)
...
<!--#include file="X001P101_C.ASP"-->
</table> 

<form action="X001P101PR.asp?CLA001=<%=wCLA001%>&CLA002=<%=wCLA002%>" target="main" name="FrmProcesar" method="post">
...
if ("<%=wSPP%>"=='0'&&"<%=wMNE%>">'0'){
   text=text+"<TR><td><p align='Left' style='margin-top: 0px'><font face='Tahoma' style='font-size: 8pt'><b>*Recuerde que para Culminar el Pedido y Enviarlo a Carvica debe Pulsar El Botón &quot;Procesar&quot;</b></font><font face='Tahoma' style='font-size: 8pt'></font></td></TR>";
}
text=text+"</table>"
