...
<% IF wSPP = "0" THEN  %>  
	<tr>
          <td width="53%"  >
          <p align="right">
			<span style="font-size: 8pt">Mostrar Únicamente Productos con 
			Existencia</span><font color="#000000" style="font-size: 8pt" >:</font></p>
		...
		%>
		  ...
		  <INPUT type="text" NAME="DESCRIPCION" size=20 value="<%=wCLA004%>" tabindex="1" style="font-size: 8pt; font-family: Tahoma" >
          </td>
          ...
          <td align="right" >
			<SELECT name="FAMILIA" type="select-one" SelectedIndex style="font-family: Tahoma; font-size: 8pt" size="1" onkeypress="return KeyPress(event);" > <!--onchange="Javascript:enviar();" ondblclick="Javascript:enviar();" -->
									<%
          ...
          <p align="center">
          <INPUT TYPE="submit" NAME="send" VALUE="Buscar" tabindex="2" style="font-family: Tahoma; font-size: 10pt; float:left; width:70; height:22">          
          </td>
        </tr>
        <tr>
        <td  colspan="6">
         <p align="center">
			<font color="#000000" style="font-size: 8pt; font-weight:700">*Recuerde 
			Indicar un Criterio o seleccionar una Línea para Buscar y Agregar Productos</font></p>
          </td>
        </td>
...
<tr>
          <td width="100%" style="border-style: none; border-width: medium; " >
            <p align="center">
			<font color="#000000" style="font-size: 8pt; font-weight:700">*Si desea Agregar Productos debe Crear un Nuevo Pedido</font></p>
          </td>
...
<% END IF%>
  ...
  <tr>
<td align= "center" >
    <table bordercolor="#ffffff" bgcolor="<%=Request.Cookies("CAR")("Color2")%>" BORDER="1" width="919"  style="border-style: inset; border-width: 1px; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px"  >
    <TR>
		<!--<td CLASS="TDP" width="35%" align="center"><A href="<%=wURLP %>" target="main">Agregar Item</A></td>-->
		<td CLASS="TDP" width="50%" align="center" height="25"><A href="<%=wURLR %>" target="_parent">Encabezado de Pedidos</A></td>		  
