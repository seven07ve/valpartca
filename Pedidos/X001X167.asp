...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF703 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300703CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300703CON ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("P300703DES"))
			wPUS = trim(rstQuery.Fields("P300703PUS"))
			wFAC = trim(rstQuery.Fields("P300703FAC"))
