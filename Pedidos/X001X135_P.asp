...
<body align="center" style="text-align: center" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" bgcolor="<%=Request.Cookies("CAR")("Color1")%>"   >
...
<table WIDTH="919" bgcolor="#FFFFFF" align="center" height="100%"><tr><td valign="top" >
    <table bordercolor="#FF" bgcolor="<%=Request.Cookies("CAR")("Color2")%>" BORDER="1" WIDTH="919"  style="border-style: inset; border-width: 1px; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" >
    <TR>
			...
			<td CLASS="TDP" width="20%" align="center"><A href="X001X134_S.ASP?NOMTAB=X300BF121" target="_parent">Atras</A></td>		  
