...
<td bgcolor="#FFFFFF">
    ...
    <table align="center" cellspacing="2" bordercolor="#ffffff" bgcolor="<%=Request.Cookies("CAR")("Color2")%>" BORDER="1" width="919"  style="border-style: inset; border-width: 1px; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px" >
    ...
    <TR>
		...
		<td CLASS="TDP" width="42%" align="center" height="25"><A href="<%=wURLP %>" target="main1" >Buscar</A></td>		  
