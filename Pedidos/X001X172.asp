...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF706 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300706CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300706CON ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wLIN = trim(rstQuery.Fields("P300706LIN"))
			wTIP = trim(rstQuery.Fields("P300706TIP"))
			wMAR = trim(rstQuery.Fields("P300706MAR"))
			wPUS = trim(rstQuery.Fields("P300706PUS"))
			wFAC = trim(rstQuery.Fields("P300706FAC"))
...
<br>
   <table align="center" BORDER="1" WIDTH="650" cellspacing="0" cellpadding="0"  bordercolor="#FFFF" bgcolor="<%=Request.Cookies("CAR")("Color2")%>" style="border-style: inset; border-width: 1px; padding-left: 1px; padding-right: 1px; padding-top: 1px; padding-bottom: 1px">
	  ...
	  <table BORDER="0" WIDTH="100%" cellpadding="5" >
		 ...
		 <tr>
          <td class="TDS" width="20%" ><p CLASS="P1" align="left">Código:</p></td>
          <td class="TDD" width="80%" ><p CLASS="P1"><INPUT NAME="wCLA" <%= wDisabled %> size=15 value="<%=wCLA001%>" maxlength="20"></P></td>
         </tr>

		 <tr>
          <td class="TDS" width="20%" ><p CLASS="P1" align="left">Línea:</td>
          <td class="TDD" width="80%" >
             <select name="LIN">
			<optgroup label="Por favor seleccione">
		 <%         
		...
		%>	  
		  ...
		  <tr>
          <td class="TDS" width="20%" ><p CLASS="P1" align="left">Familia / Tipo:</td>
          <td class="TDD" width="80%" >
          <select name="TIP">
			<optgroup label="Por favor seleccione">
		 <%         
				SQL = " SELECT P300708TIP, P300708DEC FROM X300PF708 " 																	
 				SQL = SQL & " WHERE "
				SQL = SQL & " P300708CCI = '" & trim(Session("glCiaInternet")) & "' "
  ...
  <tr>
          <td class="TDS" width="20%" ><p CLASS="P1" align="left">Marca:</td>
          <td class="TDD" width="80%" >
          <select name="MAR">
			<optgroup label="Por favor seleccione">
		 <%         
				SQL = " SELECT P300709MAR, P300709DEC FROM X300PF709 " 																	
 				SQL = SQL & " WHERE "
				SQL = SQL & " P300709CCI = '" & trim(Session("glCiaInternet")) & "' "
