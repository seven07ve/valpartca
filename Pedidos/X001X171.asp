...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
	...
	wTIT = "Marca Producto de Interes" 
	wCLA001 = trim(Request.QueryString("CLA001"))
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF709 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300709CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300709MAR ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("P300709DEC"))
			wPUS = trim(rstQuery.Fields("P300709PUS"))
			wFAC = trim(rstQuery.Fields("P300709FAC"))
