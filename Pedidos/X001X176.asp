...
<title>Unidades Vendidas por Familia y por Cliente</title>
...
<p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
	...
	<tr>
		...
		<font face="Tahoma" size="2"><font size="2"><b>Unidades Vendidas (l)</b></font></td>
	...
	<%			
		...
		SQL = SQL & " ISNULL(SUM(B300201UPE*B300201UNR), 0) AS UVE, count(DISTINCT B300201CPR) as ITE "
		SQL = SQL & " FROM X300BF201, X300BQ200 " 
		SQL = SQL & " WHERE "
		...
		SQL = SQL & " GROUP BY B300200CCL, A300002RSO "
