...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
	...
	wTIT = "Familia / Tipo Producto de Interes" 
	wCLA001 = trim(Request.QueryString("CLA001"))
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF708 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300708CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300708TIP ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("P300708DEC"))
			wPUS = trim(rstQuery.Fields("P300708PUS"))
			wFAC = trim(rstQuery.Fields("P300708FAC"))
