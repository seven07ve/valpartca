...
wURL  = "X001A101M"   'Colocar nombre principal de pagina
...
<meta name="ProgId" content="FrontPage.Editor.Document">
   ...
   <% IF wURLD2 = "X001A101M.asp" THEN %>
	 <frameset rows="55,*,80" framespacing="0" border="0" frameborder="0">
