...
<SCRIPT LANGUAGE="javascript" type="text/javascript">
    ...
    IF len(wCLA001) > 0 then	 
		...
		SQL = "SELECT * FROM X300PF701 " 
		SQL = SQL & " WHERE "
		SQL = SQL & " P300701CCI = '" & wCCI & "' AND "
		SQL = SQL & " P300701CON ='" &  wCLA001 & "'" 	

		wACT = ""
		Set rstQuery = Server.CreateObject("ADODB.Recordset")
		rstQuery.Open sql , strCnn
		if NOT rstQuery.EOF then
			wDEL = trim(rstQuery.Fields("P300701DES"))
			wPUS = trim(rstQuery.Fields("P300701PUS"))
			wFAC = trim(rstQuery.Fields("P300701FAC"))
