...
Partial Class C001E004
    ...
    Sub Enviar_Correo()
        ...
        'wBody += "<br><br><font face=""Arial"" size=""2"">Info-Alascorp</font><br><br>"
        wBody += "<font face=""Arial"" size=""2"">*** Por favor no responda a este mensaje de respuesta automática ***</font>"

        correo.From = New System.Net.Mail.MailAddress("info@valpartca.com", "Reclamos Corporacion Valparts")

        correo.To.Add("apineda@insystech.com.ve")
        ...
        'smtp.EnableSsl = True
        'smtp.Credentials = New System.Net.NetworkCredential("info@grupoitalven.com", "Ep123456")
        ...
        Finally
            ...
            Try
                ...
                Response.Redirect("../Pedidos/X001A005.asp")
    ...
    Sub Actualizar_Reclamo()
        ...
        wBody += "<font face=""Arial"" size=""2""><br><b>Comentarios: </b>" & wCRE & "</font><br><br>"
        ...
        'wBody += "<br><br><font face=""Arial"" size=""2"">Info-La Alascorp</font><br><br>"
        wBody += "<font face=""Arial"" size=""2"">*** Por favor no responda a este mensaje de respuesta automática ***</font>"

        correo.From = New System.Net.Mail.MailAddress("info@grupoitalven.com", "Reclamos Corporacion Valparts")
